      ...
      <div className="min-h-screen bg-background pt-24 pb-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex gap-3 mb-8 overflow-x-auto pb-2">
            {["SMP", "UHC", "Crystal", "Sword", "Nethpot", "DiaSMP", "Mace PvP", "ALL"].map((mode) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div
                        className={`px-4 py-2 rounded-lg ${getTierBgColor(String(displayValue), selectedGameMode)} group-hover:shadow-md group-hover:shadow-primary/20 transition-all min-w-max`}
                      >
                        <p className={`font-bold text-sm ${getTierColor(String(displayValue), selectedGameMode)}`}>
                          {displayValue}
                        </p>
                      </div>
                    </div>
