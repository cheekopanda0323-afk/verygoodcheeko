          ...
          <table className="w-full min-w-[600px] sm:min-w-full">
            <thead>
              <tr className="border-b border-border">
                <th className="text-left py-3 px-2 sm:py-4 sm:px-4 text-muted-foreground font-semibold text-sm sm:text-base">
                  Rank
                </th>
                <th className="text-left py-3 px-2 sm:py-4 sm:px-4 text-muted-foreground font-semibold text-sm sm:text-base">
                  Player
            ...
            <tbody>
              {filteredPlayers.map((player, index) => (
                <tr key={player.id} className="border-b border-border hover:bg-card/50 transition-colors">
                  <td className="py-2 px-2 sm:py-4 sm:px-4 text-primary font-bold text-sm sm:text-base">
                    #{index + 1}
                  </td>
                  ...
                  <td
                    className={`py-2 px-2 sm:py-4 sm:px-4 font-bold text-sm sm:text-base ${getTierColor(player.tier)}`}
                  >
                    {player.tier}
                  </td>
                  <td className="py-2 px-2 sm:py-4 sm:px-4 text-primary font-bold text-sm sm:text-base">
                  ...
                  <td className="py-2 px-2 sm:py-4 sm:px-4 text-muted-foreground text-sm sm:text-base">
                    {player.gameMode}
                  </td>
                </tr>
              ))}
